var countries = [
  { name: ko.observable('Afghanistan'), code: ko.observable('AF') },
  ...
  { name: ko.observable('Argentina'), code: ko.observable('AR') },
...
ViewModel = function () {
    ...
    this.countryName = ko.computed(function () {
        return this.country() != null && ko.utils.unwrapObservable(this.country().name) || "";
    }, this);
